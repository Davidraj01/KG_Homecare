...
const reviewSchema = {
  ...
  review: {
    ...
    reviewBody:
      "KG Home Care provided professional service with experienced technicians, clear communication, and excellent customer support throughout the process.",
  },
};
...
const faqSchema = {
  ...
  mainEntity: [
    ...
    {
      "@type": "Question",
      name: "What makes KG Home Care different?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "KG Home Care focuses on quality workmanship, transparent pricing, experienced technicians, and reliable customer support to ensure every customer receives professional washing machine service.",
      },
    },
    {
      "@type": "Question",
      name: "Which washing machine brands does KG Home Care handle?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "We work with all major washing machine brands, including LG, Samsung, IFB, Whirlpool, Bosch, Haier, Panasonic, Godrej, Siemens, Videocon, and many others.",
      },
    },
    {
      "@type": "Question",
    ...
    {
      "@type": "Question",
      name: "What is the mission of KG Home Care?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Our mission is to provide dependable washing machine solutions through skilled technicians, quality workmanship, honest service, and customer satisfaction.",
      },
    },
  ],
};
