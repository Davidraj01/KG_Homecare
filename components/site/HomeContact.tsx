...
export function HomeContact() {
  return (
    <div className="grid gap-6 lg:grid-cols-[1.2fr_0.8fr] lg:items-stretch">
      ...
      {/* ── LEFT: form ── */}
      <ScrollReveal scaleFrom={0.94} duration={650}>
      ...
      {/* ── RIGHT: trust points ── */}
      <ScrollReveal scaleFrom={0.94} duration={650} delay={150}>
        <div className="flex h-full flex-col justify-center gap-4 rounded-2xl border border-border bg-secondary/30 p-6 shadow-soft md:p-8">
